...
let Article = {
    render: async () => {
        ...
        return `
            ...
            <div class="row">
                <div class="col-6 col-lg-3 container text-left mt-4 p-2">
                    <div class="row">
                        <div class="col-12">
                            <img class="img-fluid" src="assets/img/zapato.jpg">
                        </div>
                        <div class="col-12 mt-2">
                            Zapato deportivo adidas
                        </div>
                        ...
                        <div class="col-12 mt-2">
                            <h5 class="font-weight-bold">$ 24000</h5>
                        </div>
                        <div class="col-12 mt-2 text-center font-weight-bold">
                            <div class="btn-yellow pt-1 pb-1">Detalles</div>
                        </div>
                    </div>
                    <hr>
                </div>
